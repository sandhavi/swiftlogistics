...
function RegisterForm() {
    ...
    return (
        <div className="min-h-screen bg-white flex font-para text-gray-900 font-poppins tracking-wider">
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-md">
                    ...
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-2 font-lora">Create Account</h2>
